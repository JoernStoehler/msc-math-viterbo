...
Please write the full verbatim initial context into docs/94-codex-cli-context.md and an explanation, e.g the parts, and your interpretation of the context, into docs/95-codex-cli-context-discussion.md
