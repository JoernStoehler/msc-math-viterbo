...
- **test_capacity_matches_baseline** — Cross-checks reference capacities against catalogued
...
- **test_normalize_bounds_rejects_nan_entries** — Ensures NaNs are rejected during bounds
