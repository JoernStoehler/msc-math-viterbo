...
This module ports the full Haim–Kislev subset machinery into
``viterbo.modern`` while keeping the original helper exposed for
...
from viterbo.modern.symplectic import standard_symplectic_matrix
