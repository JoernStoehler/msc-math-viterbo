"""Optimised polytope combinatorics built atop accelerated half-space solves."""
...
vertices_from_halfspaces = halfspaces_optimized.enumerate_vertices
...
def polytope_combinatorics(
    ...
    *,
    ...
    """Compute combinatorics using optimised vertex enumeration."""
